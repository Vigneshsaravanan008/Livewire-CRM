                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="user-panel d-flex">
                                                        <div class="image">
                                                            <img src="{{asset('uploads/'.$customer->image)}}" class="img-circle elevation-2" alt="User Image">
                                                        </div>
                                                        <div class="info">
                                                ...
                                                <td>
                                                    <button class="btn btn-primary" wire:click="editCustomer({{$customer->id}})"><i class="far fa-edit"></i></button>
                                                    <button class="btn btn-danger delete" data-value="{{$customer->id}}"><i class="fas fa-trash-alt"></i></button>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>State</label>
                                    <select class="form-control state_dropdown select2 @error('state_id') is-invalid @enderror"
                                        wire:model="state_id">
